                    ...
                    <div class="col-md-9 single-grid">
                        <div clas="single-top">
                                ...
                                <div class="flexslider">
                                    <ul class="slides">
                                        <li data-thumb="{{ asset($product->product_image) }}">
                                            <div class="thumb-image"> <img src="{{ asset($product->product_image) }}"
                            ...
                            <div class="single-right simpleCart_shelfItem">
                                ...
                                <p class="price item_price">TK. {{ $product->product_price }}.00</p>
                                    ...
                                    <div id="myTabContent" class="tab-content">
                                        <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                                            <div class="descr">
                                                ...
                                                <div class="video">
                                                    <img src="{{ asset($product->product_image)}}" data-imagezoom="true" class="img-responsive"> </div>
{{--                                                    <iframe src="https://player.vimeo.com/video/22158502" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>--}}
                                                ...
                                                <p class="quote">{!! $product->long_description !!}</p>
        ...
        <div class="new-arrivals-w3agile">
            <div class="container">
                <h3 class="tittle1">Related Product</h3>
                <div class="arrivals-grids">
                    ...
                    <div class="col-md-3 arrival-grid simpleCart_shelfItem">
                        <div class="grid-arr">
                            <div  class="grid-arrival">
                                <figure>
                                    <a href="{{ route('product-details', $relatedProduct->id) }}">
                                        <div class="grid-img">
                                            <img  src="{{ asset($relatedProduct->product_image) }}"
                            ...
                            <div class="women">
                                <h6><a href="{{ route('product-details', $relatedProduct->id) }}">{{
                                $relatedProduct->product_name
                                }}</a></h6>
                                <p ><em class="item_price">TK. {{ $relatedProduct->product_price }}.00</em></p>
