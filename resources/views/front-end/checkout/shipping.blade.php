    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <br/>
                <h3>Shipping Info goes heren ...</h3>
                <br/>
{{--                @dd($customer);--}}
                ...
                <div class="form-group">
                    <input type="email" value="{{ $customer->email_address }}" name="email_address"
                ...
                <div class="form-group">
                    <textarea name="address" placeholder="Address" class="form-control">{{ $customer->address
                    }}</textarea>
                </div>
                <div class="form-group">
